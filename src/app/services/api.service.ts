...
export class Api {
  ...
  searchMovie = searchInput => {
    ...
    return this.http.get(
      this.apiUrl +
        "q=" +
        searchInput +
        "-!1900,2018-!0,5-!0,10-!0-!Any-!Any-!Any-!gt100-!{downloadable}&t=ns&cl=all&st=adv&ob=Relevance&p=1&sa=and",
      { headers }
    );
  };
  ...
  getMovie = (videoType, startYear, endYear, country, genre) => {
    ...
    return this.http.get(
      this.apiUrl +
        ...
        "-!" +
        videoType +
        "-!Any-!Any-!gt0-!{downloadable}&t=ns&cl=" +
        country +
        "&st=adv&ob=Relevance&p=1&sa=and",
      { headers }
    );
  };
  ...
  getImdbDetails = imdbId => {
    ...
    return this.http.get(this.apiUrl + "t=getimdb" + "&q=" + imdbId, {
      headers
    });
  };
}
